...
<script type="text/javascript">
	...
	function onselected(){
		...
		else
		{
			...
			if(juan==0){
				$("#shangtoutiao").append("<div class=\"form_row\"><label id=\"zhuyi\">test</label></div>");
			}			
		}
    ...
    <div class="menu">
		...
		<div class="center_content_pages">
            ...
            <div class="morenews"> 
            	   ...
            	   <h2 id="MoreNewsTitle">部门新闻上传———${news.newsID}</h2>
                   ...
                   <div class="form">
                       ...
                       <form id="file_upload_id" action="<%=request.getContextPath()%>/upload/uploading/file" method="post" enctype="multipart/form-data">
                       		<div class="form_row">
                        		...
                        		<input type="file" class="form_file1" id="files" name="files" onchange="FileUpload_onselect(this)"/>
                        	</div>
                       </form>
